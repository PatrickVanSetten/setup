...
voorbeeld: [nevobo feed="http://www.volleybal.nl/application/handlers/export.php?format=rss&type=team&programma=4106DS+4&iRegionId=5000" aantal=3 sporthal=1 nevobo_maps=1]
...
Er zijn geen screenshots beschikbaar. Klik <a href="http://masselink.net/projecten/nevobo-feed" taget="_blank">hier</a> om de plugin in werking te zien. Ook <a href="http://krekkers.nl" taget="_blank">Krekkers.nl</a> maakt gebruik van de plugin.
...
Door gebruik te maken van de Adsense mogelijheid zal er ook een advertentie getoond worden namens Nevobo-feed.
